...
and  double mach reflection problem use
$P^3$ variational finite volume method declared in
...
Only the convergence of nonlinear time stepping residual
...
The peak value in the vortex center produce by HIRK $c_2=0.5$ is comparable with 
...
The evaluating region is limited to $[4,9]\times[4,9]=25$ where the vortex core resides
to exclude the effect of periodic boundary which 
should have been a infinite boundary in analytic solution.
