...
The compressible Navier-Stokes equations have the conservative form:
\begin{equation}
    \label{eq:NS}
...
dual time stepping
.
% , which will be explained in \ref{sssec:numScan}.
...
In practice, the implicit equations \eeqref{eq:DISum}
and \eeqref{eq:TRSum} are solved iteratively. 
